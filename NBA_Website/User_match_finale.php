...
$result = getMatches_user_finale($conn);
?>
...
<head>
    ...
    <title>Finales - Utilisateur</title>
    <link rel="stylesheet" href="User_match_finale.css">
</head>
<body>
    <header>
        <nav>
            <ul>
                ...
                <li><a href="User_match_finale.php" class="active">Finales</a></li>
            </ul>
        </nav>
    </header>
