...
include 'Demi_Finale.php';

$conn = connectDatabase();
checkAndCreateMatches($conn, 14, 'automatic_match_Demi_final');
...
<head>
    ...
    <link rel="stylesheet" href="Page_Demi_Finale.css">
</head>
<body>
    <header>
        <nav>
            <ul>
                ...
                <li><a href="Page_Demi_Finale.php" class="active">Demi-Finales</a></li>
                <li><a href="Page_Finale.php">Finales</a></li>
            </ul>
        </nav>
    </header>
