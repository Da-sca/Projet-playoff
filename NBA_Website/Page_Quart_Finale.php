...
include 'Quart.php';
checkAndCreateMatches($conn, 12, 'automatic_match_Quart_de_final');
...
<head>
    ...
    <title>Quart de Finale</title>
    <link rel="stylesheet" href="Page_Quart_Finale.css">
</head>
<body>
    <header>
        <nav>
            <ul>
                ...
                <li><a href="quart_de_final.php" class="active">Quart de Finale</a></li>
    ...
    <footer>
        <p>&copy; 2025 Quart de Finale NBA</p>
    </footer>
</body>
</html>
