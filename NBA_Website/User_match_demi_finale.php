...
$result = getMatches_user_demi($conn);
?>
...
<head>
    ...
    <title>Demi-Finales - Utilisateur</title>
    <link rel="stylesheet" href="User_match_demi_finale.css">
</head>
<body>
    <header>
        <nav>
            <ul>
                ...
                <li><a href="User_match_demi_finale.php" class="active">Demi-Finales</a></li>
            </ul>
        </nav>
    </header>
