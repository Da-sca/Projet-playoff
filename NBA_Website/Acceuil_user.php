...
<head>
    ...
    <link rel="stylesheet" href="Acceuil_user.css">
</head>
<body>
    <header>
        <nav>
            <ul>
                <li><a href="Acceuil_user.php" class="active">Accueil</a></li>
                ...
                <li><a href="Classement_equipe.php">Classement des equipes</a></li>
            </ul>
        </nav>
    ...
    <div class="cards">
        <div class="card" style="grid-area: card1;">
            ...
            <a href="Match_user.php">Matchs</a>
        </div>
        ...
        <div class="card" style="grid-area: card3;">
            ...
            <a href="Classement_user.php">Classement</a>
        </div>
    </div>
